...
private:
    ...
    */
    ...
    //相机内参
    Mat GuangcaremaMatrix = (cv::Mat_<float>(3, 3) <<
            1281.2415311337063031, -0.3089685211182275, 654.0926382032376978,
            0.0000000000000000, 1283.0023551375293209, 510.1706263660812510,
            0.0000000000000000, 0.0000000000000000, 1.0000000000000000);
    Mat GuangdistCoeffs = (cv::Mat_<float>(1, 5) << -0.0728917229903051, -0.1316730024507187, -0.0024528112888193, -0.0006391130756001, 0.0000000000000000);
};
